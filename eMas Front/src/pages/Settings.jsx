...
const Settings = () => {
  ...
  const scheduleSave = useCallback(() => {
    ...
    saveTimerRef.current = setTimeout(() => { handleSave() }, 1200)
  ...
  if (loading) {
    return (
      <div className="flex-1 p-8 flex items-center justify-center text-gray-500 dark:text-gray-400 gap-3">
      ...
      <div className="grid grid-cols-1 gap-12 mt-2">
        ...
        <Section title="User Preferences">
          ...
          <SettingRow title="Language" description="Select your preferred interface language.">
            <select
              ...
              className="w-48 bg-gray-100 dark:bg-[#27363a] border border-gray-200 dark:border-[#27363a] text-gray-900 dark:text-white text-sm rounded-md py-2 px-3 focus:outline-none focus:ring-1 focus:ring-primary"
            >
          ...
          <div className="pt-2 border-t border-gray-100 dark:border-gray-800">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {[
                ...
                <label key={label} className="flex items-center justify-between gap-4 py-2 px-3 rounded-lg bg-gray-50 dark:bg-gray-800/50 cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors">
          ...
          <SettingRow title="Auto-Save Interval" description="How often to auto-save form drafts (seconds).">
            <div className="flex items-center gap-2">
              <input
                ...
                className="w-20 px-3 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-[#1b2528] text-gray-900 dark:text-white text-sm focus:outline-none focus:ring-2 focus:ring-primary transition-colors"
              />
            ...
            <>
              <SettingRow title="Lock-in window (minutes)" description="Time window within which slots are locked from rescheduling.">
                <input
                  ...
                  className="w-24 px-3 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-[#1b2528] text-gray-900 dark:text-white text-sm focus:outline-none focus:ring-2 focus:ring-primary"
                />
              </SettingRow>
              ...
              <SettingRow title="Split Strategy" description="How to split parallel steps when scheduling.">
                <select
                  ...
                  className="w-56 bg-gray-100 dark:bg-[#27363a] border border-gray-200 dark:border-[#27363a] text-gray-900 dark:text-white text-sm rounded-md py-2 px-3 focus:outline-none focus:ring-1 focus:ring-primary"
                >
              ...
              <SettingRow title="Work start time" description="Daily shift start (24h).">
                <input
                  ...
                  className="w-28 px-3 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-[#1b2528] text-gray-900 dark:text-white text-sm focus:outline-none focus:ring-2 focus:ring-primary"
                />
              </SettingRow>
              ...
              <SettingRow title="Workdays" description="Days when work is scheduled (Mon–Sat typical).">
                <div className="flex flex-wrap gap-2">
                  {[
                    ...
                    <label key={key} className="flex items-center gap-1.5 px-2 py-1.5 rounded-lg bg-gray-50 dark:bg-gray-800/50 cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-800 text-sm">
                      <input
                        type="checkbox"
                ...
                <div className="space-y-2">
                  <div className="flex gap-2">
                    <input
                      ...
                      className="w-36 px-3 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-[#1b2528] text-gray-900 dark:text-white text-sm focus:outline-none focus:ring-2 focus:ring-primary"
                    />
                    <button
                      type="button"
                      onClick={() => {
                      ...
                      className="px-3 py-2 rounded-lg bg-gray-100 dark:bg-[#27363a] border border-gray-200 dark:border-gray-700 text-gray-900 dark:text-white text-sm font-medium hover:bg-gray-200 dark:hover:bg-[#394f56] disabled:opacity-50"
                    >
                      Add
                    </button>
                  </div>
                  {publicHolidays.length > 0 && (
                    <ul className="flex flex-wrap gap-1.5">
                      {publicHolidays.map((d) => (
                        <li key={d} className="inline-flex items-center gap-1 px-2 py-1 rounded-lg bg-gray-100 dark:bg-gray-800 text-sm">
                          {d}
                          <button
                            type="button"
                            onClick={() => {
                            ...
                            className="p-0.5 rounded text-gray-500 hover:text-red-600 hover:bg-red-50 dark:hover:bg-red-900/20"
                            aria-label={`Remove ${d}`}
                          >
              ...
              <div className="pt-2">
                <button
                  ...
                  className="flex items-center gap-2 h-9 px-4 bg-gray-100 dark:bg-[#27363a] border border-gray-200 dark:border-gray-700 text-gray-900 dark:text-white text-sm font-medium rounded-lg hover:bg-gray-200 dark:hover:bg-[#394f56] transition-colors disabled:opacity-50"
                >
        ...
        <Section title="ERP / MES Integration">
          <div className="mb-4 flex items-center gap-3">
            ...
            {erpLastSync && (
              <p className="text-xs text-gray-500 dark:text-gray-400">Last sync: {erpLastSync}</p>
            )}
          </div>
          ...
          <SettingRow title="API Endpoint" description="URL for the ERP/MES synchronisation endpoint.">
            <input
              ...
              className="w-80 px-3 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-[#1b2528] text-gray-900 dark:text-white text-sm placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-primary transition-colors"
            />
          </SettingRow>
        ...
        <Section title="About eMAS">
          <div className="flex items-center gap-6">
            <div>
              <p className="text-sm font-semibold text-gray-900 dark:text-white">eMAS — Enterprise Manufacturing Automation System</p>
              <p className="text-xs text-gray-500 dark:text-gray-400 mt-0.5">Version 1.0.0 · Build 2026.02</p>
            </div>
          </div>
          <div className="mt-4 flex items-center gap-3">
            <span className="flex items-center gap-1.5 text-xs px-2.5 py-1 rounded-full bg-green-100 dark:bg-green-900/20 text-green-700 dark:text-green-400">
              <span className="w-1.5 h-1.5 bg-green-500 rounded-full" />API Connected
            </span>
            <span className="text-xs text-gray-500 dark:text-gray-400">Backend: http://localhost:8080/api/v1</span>
          </div>
        </Section>
      </div>
    </div>
...
const Section = ({ title, children }) => (
  <div>
    <h2 className="text-xl font-semibold text-gray-900 dark:text-white border-b border-gray-200 dark:border-[#27363a] pb-3 mb-6">
      {title}
    </h2>
...
const ErpStatusBadge = ({ status }) => {
  const cfg = {
    connected:    { bg: 'bg-green-100 dark:bg-green-900/20', text: 'text-green-700 dark:text-green-400', dot: 'bg-green-500', label: 'Connected' },
    disconnected: { bg: 'bg-gray-100 dark:bg-gray-800',     text: 'text-gray-600 dark:text-gray-400',   dot: 'bg-gray-400',  label: 'Disconnected' },
    testing:      { bg: 'bg-blue-100 dark:bg-blue-900/20',  text: 'text-blue-700 dark:text-blue-400',   dot: 'bg-blue-500',  label: 'Testing…' },
  }
